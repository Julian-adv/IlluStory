...
{#if readOnly}
  <div class='font-serif prose leading-relaxed markdown text-gray-900' style={cssVarStyles}>
    ...
    <Button color='alternative' class={'w-6 h-6 p-0 focus:ring-0 bg-stone-100 inline-flex justify-center ml-1 text-stone-400 focus:text-stone-400'} on:click={generateNewImage}>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
